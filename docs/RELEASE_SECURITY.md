...
- Publish to npm with provenance only after smoke jobs pass. Stable release tags require `NPM_TOKEN`; RC tags attach signed GitHub Release artifacts and intentionally skip npm publish.
