...
> [!IMPORTANT]
> PGV advice is advisory-only. It never overrides verify, never grants admission authority, and never silently blocks execution. Completion is admitted _only_ when the read-only verify gate passes.
